...
Payment will be made from this account:<br><br> <INPUT type=text class=inpts name=FORCED_PAYER_ACCOUNT value="';
        echo app('data')->settings['def_payee_account'];
        echo '">
...
<INPUT type=hidden name=PAYMENT_URL value="';
        echo app('data')->env['HTTPS'] ? 'https' : 'http';
        echo '://';
        echo app('data')->env['HTTP_HOST'].app('data')->env['SCRIPT_NAME'];
...
<INPUT type=hidden value="Withdraw to ';
        echo $user['name'];
        echo ' from ';
        echo app('data')->settings['site_name'];
  ...
  ';
         ...
         ';
                                                ...
                                                send_template_mail('withdraw_user_notification', $userinfo['email'],
                                                    app('data')->settings['opt_in_email'], $info);
...
<input type="hidden" name="_token" value="'.csrf_token().'"></form>';
                                                ...
                                                echo $to_withdraw;
                                                echo '</b> of ';
                                                echo app('data')->exchange_systems[$trans['ec']]['name'];
